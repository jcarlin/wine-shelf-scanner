...
from app.routes import scan_router, feedback_router, report_router, reviews_router, device_router, client_config_router
...
app.include_router(client_config_router, tags=["config"])
